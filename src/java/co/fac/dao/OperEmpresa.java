...
//    private static final Logger LOG = LogManager.getLogger(OperEmpresa.class);
    ...
    public int iniciarSesion(Empresa usuario) {
        ...
        if (miconec != null) {
            ...
            try {
                PreparedStatement ps;
                ps = miconec.prepareStatement("SELECT usuario, contrasena FROM public.empresas "
                ...
                if (results.next()) {
                    e = new Empresa(results.getString(1), results.getString(2));
        ...
        //Retorno 1 si encontro al usuario
        return 1;
    }
}
